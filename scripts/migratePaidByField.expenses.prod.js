...
// Polyfill __filename and __dirname in ES modules
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// Use the production service account key
const serviceAccount = await import(path.resolve(__dirname, '../serviceAccountKey.json'), { assert: { type: "json" } }).then(m => m.default);
