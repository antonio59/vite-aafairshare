...
// Usage: npm tsx scripts/sync-monthly-data.ts --month YYYY-MM [--dry-run]
// Syncs Firestore data for a given month from production to staging.
// Requires: npm install -D yargs @types/yargs
// If you see import errors for yargs, ensure you have installed it and its types.
...
(async () => {
  ...
  // Note: App.delete() is not typed on App and is not required for short-lived scripts.
  // If you run this in a long-lived process, consider cleaning up Firebase apps manually.
