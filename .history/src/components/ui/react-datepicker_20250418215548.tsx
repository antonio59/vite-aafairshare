      ...
      <Popover.Trigger asChild>
        <div className="relative w-full">
          <Input
            ...
            className={cn(
              "border-0 shadow-none pl-7 h-[40px] text-base w-full bg-background cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
