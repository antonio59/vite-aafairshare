  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Trigger asChild>
        <div className="relative w-full">
          <Input
            ...
            className={cn(
              "h-[40px] pl-10 pr-3 border-0 shadow-none text-base w-full cursor-pointer bg-background focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
      ...
      <Popover.Content
        align="start"
        sideOffset={8}
        className="z-50 mt-2 w-[272px] bg-background border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-0"
      >
        <ReactDatePicker
          selected={value}
