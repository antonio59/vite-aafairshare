...
import { Category, CategoryIconName } from "@shared/types";
import { z } from "zod";
...
const formSchema = z.object({
  ...
  icon: z.custom<CategoryIconName>((val) => typeof val === 'string', "Please select an icon")
});

type FormData = z.infer<typeof formSchema>;

// Add this utility to get all icon names as values
const ICON_NAMES: CategoryIconName[] = [
  'Subscriptions',
  'Utilities',
  'Gifts',
  'Holidays',
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    {ICON_NAMES.map((iconName: CategoryIconName) => {
