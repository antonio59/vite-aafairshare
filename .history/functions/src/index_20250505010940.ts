...
export const onSettlementCreated = functionsV1.region("europe-west1").firestore.document("settlements/{settlementId}")
  .onCreate(async (snap: admin.firestore.DocumentSnapshot, context: Record<string, unknown>) => {
...
export const onSettlementMarkedSettled = functionsV1.region("europe-west1").firestore.document('settlements/{settlementId}')
