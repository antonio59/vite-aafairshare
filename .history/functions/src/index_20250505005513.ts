...
// Cloud Function triggered by the creation of a settlement document
export const onSettlementCreated = functions.region("europe-west1").firestore.document("settlements/{settlementId}")
...
export const onSettlementMarkedSettled = functions.region("europe-west1").firestore.document('settlements/{settlementId}')
